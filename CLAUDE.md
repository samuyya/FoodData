...
- [x] Hecho (2026-09-17): alerta configurada en Better Stack (Telemetría → Alertas) — dispara por correo cuando aparece 1+ log con `level >= 50` (error) en el servicio FoodData. También hay un monitor de uptime aparte (Better Stack → Uptime) sobre `https://fooddata-vo3e.onrender.com`, creado de paso al configurar todo esto.
