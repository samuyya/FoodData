...
// (acceso a Administración, historial, reporte e inspección). El marcador
// `adminAtrasado` NO se limpia aquí porque debe persistir toda la sesión (8 h):
// es una sola verificación válida para cualquier formato.
